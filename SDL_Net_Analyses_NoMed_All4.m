function SDL_Net_Analyses_NoMed_All4(SDL)
...
% MRHO = rand(148*4,148,1000); % to test the procedure
...
k = 0.25 * size(Mci,1);
g11 = [1:k]; g12 = [k+1:2*k]; g21 = [2*k+1:3*k]; g22 = [3*k+1:4*k];  % index of groups

% absolute values
Thr = Thrr(1:4,:); WC = WCC(1:4,:);
...
Mc = double(Mc>0);
[dif_abs(:,:,1),p_abs(:,:,1),val_abs(:,:,1),val_abs(:,:,2)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g12,:,:)); % g11 vs g12
[dif_abs(:,:,2),p_abs(:,:,2),~,             val_abs(:,:,3)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g21,:,:)); % g11 vs g21
[dif_abs(:,:,3),p_abs(:,:,3),~,             val_abs(:,:,4)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g22,:,:)); % g11 vs g22
[dif_abs(:,:,4),p_abs(:,:,4),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g21,:,:)); % g12 vs g21
[dif_abs(:,:,5),p_abs(:,:,5),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g22,:,:)); % g12 vs g22
[dif_abs(:,:,6),p_abs(:,:,6),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g21,:,:), Mc(g22,:,:)); % g21 vs g22
[dif_abs(:,:,7),p_abs(:,:,7),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g12,:,:), Mc(g21,:,:)+Mc(g22,:,:)); % g11+g12 vs g21+g22
[dif_abs(:,:,8),p_abs(:,:,8),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g21,:,:), Mc(g12,:,:)+Mc(g22,:,:)); % g11+g21 vs g12+g22
[dif_abs(:,:,9),p_abs(:,:,9),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)-Mc(g12,:,:), Mc(g21,:,:)-Mc(g22,:,:)); % g11-g12 vs g21-g22


% pos values
Thr = Thrr(5:8,:); WC = WCC(5:8,:);
% ThC  = Thr(find(WC==max(WC(:,1)))); % the threshold corresponding to the maximum value of minimum wring cost
% Mc  = double(Mci>ThC(1));
Mc = SDL_threshold_proportional(Mci,max(WC(:,1)));
Mc = double(Mc>0);
[dif_pos(:,:,1),p_pos(:,:,1),val_pos(:,:,1),val_pos(:,:,2)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g12,:,:)); % g11 vs g12
[dif_pos(:,:,2),p_pos(:,:,2),~,             val_pos(:,:,3)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g21,:,:)); % g11 vs g21
[dif_pos(:,:,3),p_pos(:,:,3),~,             val_pos(:,:,4)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g22,:,:)); % g11 vs g22
[dif_pos(:,:,4),p_pos(:,:,4),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g21,:,:)); % g12 vs g21
[dif_pos(:,:,5),p_pos(:,:,5),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g22,:,:)); % g12 vs g22
[dif_pos(:,:,6),p_pos(:,:,6),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g21,:,:), Mc(g22,:,:)); % g21 vs g22
[dif_pos(:,:,7),p_pos(:,:,7),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g12,:,:), Mc(g21,:,:)+Mc(g22,:,:)); % g11+g12 vs g21+g22
[dif_pos(:,:,8),p_pos(:,:,8),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g21,:,:), Mc(g12,:,:)+Mc(g22,:,:)); % g11+g21 vs g12+g22
[dif_pos(:,:,9),p_pos(:,:,9),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)-Mc(g12,:,:), Mc(g21,:,:)-Mc(g22,:,:)); % g11-g12 vs g21-g22

% neg values
Thr = Thrr(9:12,:); WC = WCC(9:12,:);
% ThC  = Thr(find(WC==max(WC(:,1)))); % the threshold corresponding to the maximum value of minimum wring cost
% Mc  = double(Mci<ThC(1));
Mc = SDL_threshold_proportional(-1*Mci,max(WC(:,1)));
Mc = double(Mc>0);
[dif_neg(:,:,1),p_neg(:,:,1),val_neg(:,:,1),val_neg(:,:,2)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g12,:,:)); % g11 vs g12
[dif_neg(:,:,2),p_neg(:,:,2),~,             val_neg(:,:,3)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g21,:,:)); % g11 vs g21
[dif_neg(:,:,3),p_neg(:,:,3),~,             val_neg(:,:,4)] = SDL_Graph_Analyses(myfun,Mc(g11,:,:), Mc(g22,:,:)); % g11 vs g22
[dif_neg(:,:,4),p_neg(:,:,4),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g21,:,:)); % g12 vs g21
[dif_neg(:,:,5),p_neg(:,:,5),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g12,:,:), Mc(g22,:,:)); % g12 vs g22
[dif_neg(:,:,6),p_neg(:,:,6),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g21,:,:), Mc(g22,:,:)); % g21 vs g22
[dif_neg(:,:,7),p_neg(:,:,7),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g12,:,:), Mc(g21,:,:)+Mc(g22,:,:)); % g11+g12 vs g21+g22
[dif_neg(:,:,8),p_neg(:,:,8),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)+Mc(g21,:,:), Mc(g12,:,:)+Mc(g22,:,:)); % g11+g21 vs g12+g22
[dif_neg(:,:,9),p_neg(:,:,9),~,                          ~] = SDL_Graph_Analyses(myfun,Mc(g11,:,:)-Mc(g12,:,:), Mc(g21,:,:)-Mc(g22,:,:)); % g11-g12 vs g21-g22
