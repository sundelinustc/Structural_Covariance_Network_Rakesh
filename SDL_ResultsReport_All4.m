function SDL_ResultsReport_All4(SDL)
...
id = 1; % index for between-group comparison, id=1 means group 11 versus group12
nn = [1,2];% index for group 11 and group 12
...
T_Mc_pos11_12  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g11-g12') % pos correlations or regressions

id = 2; % index for between-group comparison, id=2 means group 11 versus group21
nn = [1,3];% index for group 11 and group 21
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos11_21  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g11-g21') % pos correlations or regressions

id = 3; % index for between-group comparison, id=3 means group 11 versus group22
nn = [1,4];% index for group 11 and group 22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos11_22  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g11-g22') % pos correlations or regressions

id = 4; % index for between-group comparison, id=4 means group 12 versus group21
nn = [2,3];% index for group 12 and group 21
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos12_21  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g11-g21') % pos correlations or regressions

id = 5; % index for between-group comparison, id=5 means group 12 versus group22
nn = [2,4];% index for group 12 and group 22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos12_22  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g12-g22') % pos correlations or regressions

id = 6; % index for between-group comparison, id=6 means group 21 versus group22
nn = [3,4];% index for group 21 and group 22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos21_22  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g21-g22') % pos correlations or regressions

id = 7; % index for between-group comparison, id=7 means group 11+12 versus group21+22
nn1 = [1,2]; nn2 = [3,4];% index for group 11+12 and group 21+22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn1) + SDL.Node_Degree.val_pos(:,:,nn2); 
val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn1) + SDL.Node_Betweenness.val_pos(:,:,nn2); 
val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn1) + SDL.Node_Closeness.val_pos(:,:,nn2); 
val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn1) + SDL.Node_Eigenvector.val_pos(:,:,nn2);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos1112_2122  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'Main of PTSD') % pos correlations or regressions

id = 8; % index for between-group comparison, id=8 means group 11+21 versus group12+22
nn1 = [1,3]; nn2 = [2,4];% index for group 11+12 and group 21+22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn1) + SDL.Node_Degree.val_pos(:,:,nn2); 
val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn1) + SDL.Node_Betweenness.val_pos(:,:,nn2); 
val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn1) + SDL.Node_Closeness.val_pos(:,:,nn2); 
val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn1) + SDL.Node_Eigenvector.val_pos(:,:,nn2);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos1121_1222  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'Main of Dep or Gender') % pos correlations or regressions

id = 9; % index for between-group comparison, id=9 means group 11+22 versus group12+21
nn1 = [1,4]; nn2 = [2,3];% index for group 11+12 and group 21+22
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn1) + SDL.Node_Degree.val_pos(:,:,nn2); 
val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn1) + SDL.Node_Betweenness.val_pos(:,:,nn2); 
val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn1) + SDL.Node_Closeness.val_pos(:,:,nn2); 
val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn1) + SDL.Node_Eigenvector.val_pos(:,:,nn2);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos1122_1221  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'Interaction') % pos correlations or regressions
...
if size(val,3) > 2 % for main and interaction effect
    T_Mc.val_degree_g1   = val(idx,1,1)+val(idx,1,2);
    T_Mc.val_degree_g2   = val(idx,1,3)+val(idx,1,4);
    T_Mc.val_betweenness_g1   = val(idx,2,1)+val(idx,2,2);
    T_Mc.val_betweenness_g2   = val(idx,2,3)+val(idx,2,4);
    T_Mc.val_closeness_g1   = val(idx,3,1)+val(idx,3,2);
    T_Mc.val_closeness_g2   = val(idx,3,3)+val(idx,3,4);
    T_Mc.val_eigenvector_g1   = val(idx,4,1)+val(idx,4,2);
    T_Mc.val_eigenvector_g2   = val(idx,4,3)+val(idx,4,4);
else
