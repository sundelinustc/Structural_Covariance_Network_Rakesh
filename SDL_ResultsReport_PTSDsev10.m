function SDL_ResultsReport_PTSDsev10(SDL)
...
nn = [1,2];% index for group 1 and group 2
...
T_Mc_pos12  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g1-g2') % pos correlations or regressions

id = 2; % index for between-group comparison, id=1 means group 1 versus group2
nn = [1,3];% index for group 1 and group 3
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos13  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g1-g3') % pos correlations or regressions

id = 3; % index for between-group comparison, id=1 means group 1 versus group2
nn = [1,4];% index for group 1 and group 4
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos14  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g1-g4') % pos correlations or regressions

id = 4; % index for between-group comparison, id=1 means group 1 versus group2
nn = [1,5];% index for group 1 and group 5
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos15  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g1-g5') % pos correlations or regressions

id = 5; % index for between-group comparison, id=1 means group 1 versus group2
nn = [2,3];% index for group 2 and group 3
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos23  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g2-g3') % pos correlations or regressions

id = 6; % index for between-group comparison, id=1 means group 1 versus group2
nn = [2,4];% index for group 2 and group 4
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos24  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g2-g4') % pos correlations or regressions

id = 7; % index for between-group comparison, id=1 means group 1 versus group2
nn = [2,5];% index for group 2 and group 5
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos25  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g2-g5') % pos correlations or regressions

id = 8; % index for between-group comparison, id=1 means group 1 versus group2
nn = [3,4];% index for group 3 and group 4
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos34  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g3-g4') % pos correlations or regressions

id = 9; % index for between-group comparison, id=1 means group 1 versus group2
nn = [3,5];% index for group 3 and group 5
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos35  = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g3-g5') % pos correlations or regressions

id = 10; % index for between-group comparison, id=1 means group 1 versus group2
nn = [4,5];% index for group 4 and group 5
val(:,1,:) = SDL.Node_Degree.val_pos(:,:,nn); val(:,2,:) = SDL.Node_Betweenness.val_pos(:,:,nn); val(:,3,:) = SDL.Node_Closeness.val_pos(:,:,nn); val(:,4,:) = SDL.Node_Eigenvector.val_pos(:,:,nn);
dif(:,1,:) = SDL.Node_Degree.dif_pos(:,:,id); dif(:,2,:) = SDL.Node_Betweenness.dif_pos(:,:,id); dif(:,3,:) = SDL.Node_Closeness.dif_pos(:,:,id); dif(:,4,:) = SDL.Node_Eigenvector.dif_pos(:,:,id);
pli(:,1,:) = SDL.Node_Degree.p_pos(:,:,id );  pli(:,2,:) = SDL.Node_Betweenness.p_pos(:,:,id );  pli(:,3,:) = SDL.Node_Closeness.p_pos(:,:,id);   pli(:,4,:) = SDL.Node_Eigenvector.p_pos(:,:,id);
T_Mc_pos45 = SDL_Reports_Node(val,dif, pli, tbl,ido,fn,'Mc_pos',BNVpath,img,'g4-g5') % pos correlations or regressions
